 ...
 * a Next.js route handler, a Hono or Remix action, a Cloudflare Worker, or
 * Express through a two-line adapter (see the README). Put it behind your own
 * authentication, the way the rest of your backend is.
 */
